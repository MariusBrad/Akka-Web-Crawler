 ...
 *
 */
public class ClusterSchedulerActor extends AbstractActor {
	...
	//Logger
		...
		public static Props props() {
			return Props.create(ClusterSchedulerActor.class);
		}
		...
		public Receive createReceive() {
			...
			return receiveBuilder()
					...
					.matchEquals(ClusterMessages.REQUEST_BATCH_URLs, this::onRequestBatchURLs)
		...
		private void onScheduleScrapedURLs(ScheduleScrapedURLs mess) {
			...
			getSender().tell(ClusterMessages.SCRAPED_URLs_SCHEDULED, getSelf());
		}
		...
		private void onRequestBatchURLs(Object mess) {
			if (!this.isFinished()) {
				...
				getSender().tell(ClusterMessages.END_OF_SCHEDULE, getSelf());
			}
		}
